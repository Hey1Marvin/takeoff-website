"use client";
/* Teilen-Knopf für Event-Karten — Web-Share-API mit Zwischenablage-
   Fallback. Portierung von wireShareButtons() aus assets/js/pages/
   events.js (gleiches Muster wie AwarenessShareButton, eigene Kopie
   pro Seiten-Namensraum). */
import { useEffect, useState } from "react";

export default function EventsShareButton({
