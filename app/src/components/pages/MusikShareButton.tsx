"use client";
/* Teilen-Knopf "Genre-Guide teilen" — Web-Share-API mit Zwischenablage-
   Fallback. Portierung von wireShareButtons() aus assets/js/pages/
   musik.js (gleiches Muster wie EventsShareButton/AwarenessShareButton,
   eigene Kopie pro Seiten-Namensraum). */
import { useEffect, useState } from "react";

export default function MusikShareButton({
  text, url, label = "Teilen", copiedToast = "Link kopiert ✓",
}: {
  text: string;
  url: string;
  label?: string;
