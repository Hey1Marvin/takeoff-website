...
export const en: Record<Key, string> = {
  ...
  "event.page.market.h3": "Market",
  "event.page.market.note": "Pop-up stalls in the foyer — brought along by befriended shops and artists.",
  "event.page.contest.h3": "DJ contest",
  "event.page.contest.expired": "Looking back — the deadline has passed.",
  "event.page.contest.by": "Hosted by",
  "event.page.contest.deadline": "Deadline",
  "event.page.contest.announce": "Announcement",
  "event.page.contest.result": "Result",
  "event.page.rules.h3": "House rules",
  "event.page.rules.note": "For everyone, no exceptions.",
  "event.page.credits.h3": "Credits",
  "event.page.credits.artwork": "Artwork",
  "event.page.credits.foerderung": "Funded by",
  "event.page.credits.drinks": "Drinks",
  ...
  "event.page.sets.h3": "Sets to revisit",
  "embed.consent.title": "External content",
  "embed.consent.body": "Playing this opens a connection to {dienst}. Until then, not a single byte goes there.",
  "embed.consent.accept": "Agree and play",
  "embed.consent.remember": "Your consent then applies to every player and can be withdrawn in the display settings.",
  "embed.consent.open": "Open on {dienst} instead",
  "embed.play": "Play",
  "player.play": "Play",
  "player.sound": "Sound",
  ...
  "crew.nav.mehr": "More",
  "crew.nav.mehrZu": "Show more",
  "crew.nav.label": "Crew navigation",
  "crew.nav.leiste": "Quick access",
